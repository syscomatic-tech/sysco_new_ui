...
const ServicesHeroSection = () => {
    return (
        <div className='bg-[url(/assets/services/servicesSection-top-banner.png)] bg-center bg-cover bg-no-repeat'>
            <div className='py-12 xl:py-28'>
                <p className='text-[36px] sm:text-[50px] lg:text-[72px] xl:text-[60px] 2xl:text-[72px] text-primary text-center font-title'>Services</p>
