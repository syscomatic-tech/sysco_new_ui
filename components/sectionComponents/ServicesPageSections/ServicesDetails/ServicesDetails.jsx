...
const ServicesDetails = () => {
    ...
    return (
        <div className='pt-12 flex flex-col divide-y divide-lightGray'>
            {
                services.map((service, index) => <div className={`py-10 md:py-16 xl:py-20 flex items-center gap-7 sm:gap-10 md:gap-14 justify-between ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                    <div>
